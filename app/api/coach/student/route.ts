...
export async function GET(req: NextRequest) {
  ...
  const [
    ...
    admin.from('profiles').select('id, full_name, first_name, last_name, email, enrolled_at, last_active_at, coach_notes, dfy_flagged, access_level, phone').eq('id', studentId).maybeSingle(),
